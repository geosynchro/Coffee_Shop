...
Item.create(name: "Just A Spoon", price: 33, description: "Yes, we know it's expensive.  The best spoon in the world to stir your coffee.", image_url: "https://images.pexels.com/photos/6166690/pexels-photo-6166690.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", item_category_id: utensils.id)
Item.create(name: "Espresso Press Kit", price: 50, description: "Perfect espresso presser thing, not sure what it does exactly...", image_url: "https://images.pexels.com/photos/4349789/pexels-photo-4349789.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", item_category_id: utensils.id)
...
Item.create(name: "Hario Pourover kit", price: 60, description: "Pour Over kit includes filters, pourover top, and pourover bottom glass.", image_url: "https://images.pexels.com/photos/5328288/pexels-photo-5328288.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", item_category_id: pourover.id)
Item.create(name: "Chemex Pourover Glass", price: 35, description: "Chemex glass is perfect for pourover coffee.", image_url: "https://images.pexels.com/photos/2616175/pexels-photo-2616175.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", item_category_id: pourover.id)
...
Item.create(name: "Basic Pourover Combo kit", price: 30, description: "Basic pourover combo kit includes the pouring glass and cup.", image_url: "https://images.pexels.com/photos/4787613/pexels-photo-4787613.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", item_category_id: pourover.id)
